...
<html>
    ...
    <body>
                ...
                <div id="parent" class="hero-body" style="overflow: auto; height: calc(100% - 76px); padding-top: 1em; padding-bottom: 0;">
                    ...
                    <div class="media-content">
                        ...
                        <p>
                            ...
                            <br>
                            ボットと対話をしてください。対話は全部で<span id="turn">20</span>発話（1人<span id="turn-half">10</span>発話ずつ）です。<br>
                            あなたが最初のメッセージを送信して対話を開始してください。
                        </p>
                        </div>
                    </div>
                    </article>
        ...
        <script>
            ...
            var randomId = Math.floor(Math.random() * (9999 - 1000)) + 1000;
            var outfile = dialogueId + '_chat_' + randomId + ".csv";
            var turn = 0;
            ...
            document.getElementById("interact").addEventListener("submit", function(event){{
                ...
                parDiv.scrollTo(0, parDiv.scrollHeight);
                var send_info = {{"utt": ntex, "context": myContext, "dialogueId": dialogueId}};
